...
export class SupernoteViewer {
  ...
  navigateToPage (pageNumber) {
    const pageId = `page-${pageNumber + 1}` // Convert to 1-indexed for page ID

    // Use the URL hash to focus the page (this is how the card viewer handles focus)
    window.location.hash = pageId

    // Trigger a re-render to ensure the page is focused
